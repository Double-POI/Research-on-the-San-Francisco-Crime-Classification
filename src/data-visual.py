...
plt.savefig('../output/picture/No. of Crime types.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by year.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.xlabel('year')
plt.title('No. of crimes by year', fontsize=20)
plt.savefig('../output/picture/No. of crimes by year（-2015）.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by month.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by month(top10).png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by day.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by hour.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by minute.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by hour(top6).png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by DayOfWeek.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by district.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.savefig('../output/picture/No. of crimes by block.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
...
plt.xlabel('X')
plt.ylabel('Y')
plt.savefig('../output/picture/scatter of crimes by coordinate.png',
            dpi=400,
            bbox_inches='tight')
plt.close('all')
